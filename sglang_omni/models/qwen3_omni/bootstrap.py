...
def create_talker_scheduler(
    ...
    *,
    ...
    # Note (wenyao): the runner attaches after construction, so it misses the
    # OmniScheduler constructor's own _async_enabled propagation.
    scheduler._model_runner._async_enabled = enable_async_decode
    return scheduler
