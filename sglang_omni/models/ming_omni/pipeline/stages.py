...
def create_talker_stream_executor(
    ...
    **kwargs: Any,
    ...
    """Create the streaming talker executor when Task 7 provides it."""
    try:
        ...
        raise ImportError(
            "Ming streaming talker executor is not available yet; "
            "Task 7 must provide "
            "sglang_omni.models.ming_omni.components.streaming_talker_executor."
        ) from exc
    local_path = _resolve_local_model_path(model_path)
